...
public class SelectCaseBuilder {
    ...
    public func send<T>(_ error: Error, to channel: FallibleChannel<T>?, closure: (Void) -> Void) {
        if let channel = channel, !channel.closed {
    ...
    public func send<T>(_ error: Error, to channel: FallibleSendingChannel<T>?, closure: (Void) -> Void) {
        if let channel = channel, !channel.closed {
